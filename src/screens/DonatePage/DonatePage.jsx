				...
				<>
					...
					<div className='info-container'>
						<div className='info-box'>
							...
							<p>
								<a href={donationLinkHebrew} target='_blank' rel='noopener noreferrer'>
									תרומה בעברית
								</a>
							</p>
							<p>
								<a href={donationLinkEnglish} target='_blank' rel='noopener noreferrer'>
									Donate in English
								</a>
							</p>
						</div>
